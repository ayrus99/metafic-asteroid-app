...
export class AsteroidProxy {
  ...
  public static Parse(d: string): AsteroidProxy {
    return AsteroidProxy.Create(JSON.parse(d));
  }
  public static Create(d: any, field: string = 'root'): AsteroidProxy {
    if (!field) {
      obj = d;
      field = "root";
    }
    ...
    d.estimated_diameter = EstimatedDiameterProxy.Create(d.estimated_diameter, field + ".estimated_diameter");
    checkBoolean(d.is_potentially_hazardous_asteroid, false, field + ".is_potentially_hazardous_asteroid");
    ...
    if (d.close_approach_data) {
      for (let i = 0; i < d.close_approach_data.length; i++) {
        d.close_approach_data[i] = CloseApproachDataEntityProxy.Create(d.close_approach_data[i], field + ".close_approach_data" + "[" + i + "]");
      }
    }
    if (d.close_approach_data === undefined) {
      d.close_approach_data = null;
    }
    d.orbital_data = OrbitalDataProxy.Create(d.orbital_data, field + ".orbital_data");
    checkBoolean(d.is_sentry_object, false, field + ".is_sentry_object");
    return new AsteroidProxy(d);
  }
...
export class EstimatedDiameterProxy {
  ...
  public static Create(d: any, field: string = 'root'): EstimatedDiameterProxy {
    ...
    d.kilometers = KilometersOrMetersOrMilesOrFeetProxy.Create(d.kilometers, field + ".kilometers");
    d.meters = KilometersOrMetersOrMilesOrFeetProxy.Create(d.meters, field + ".meters");
    d.miles = KilometersOrMetersOrMilesOrFeetProxy.Create(d.miles, field + ".miles");
    d.feet = KilometersOrMetersOrMilesOrFeetProxy.Create(d.feet, field + ".feet");
...
export class KilometersOrMetersOrMilesOrFeetProxy {
  ...
  public static Create(d: any, field: string = 'root'): KilometersOrMetersOrMilesOrFeetProxy {
    if (!field) {
      obj = d;
      field = "root";
    }
    ...
    checkNumber(d.estimated_diameter_min, false, field + ".estimated_diameter_min");
    checkNumber(d.estimated_diameter_max, false, field + ".estimated_diameter_max");
...
export class CloseApproachDataEntityProxy {
  ...
  public static Create(d: any, field: string = 'root'): CloseApproachDataEntityProxy {
    if (!field) {
      obj = d;
      field = "root";
    }
    ...
    checkString(d.close_approach_date_full, false, field + ".close_approach_date_full");
    checkNumber(d.epoch_date_close_approach, false, field + ".epoch_date_close_approach");
    d.relative_velocity = RelativeVelocityProxy.Create(d.relative_velocity, field + ".relative_velocity");
    d.miss_distance = MissDistanceProxy.Create(d.miss_distance, field + ".miss_distance");
...
export class RelativeVelocityProxy {
  ...
  public static Create(d: any, field: string = 'root'): RelativeVelocityProxy {
    ...
    checkString(d.kilometers_per_second, false, field + ".kilometers_per_second");
...
export class OrbitalDataProxy {
  ...
  public static Create(d: any, field: string = 'root'): OrbitalDataProxy {
    ...
    checkString(d.orbit_determination_date, false, field + ".orbit_determination_date");
    checkString(d.first_observation_date, false, field + ".first_observation_date");
    checkString(d.last_observation_date, false, field + ".last_observation_date");
    ...
    checkString(d.minimum_orbit_intersection, false, field + ".minimum_orbit_intersection");
    checkString(d.jupiter_tisserand_invariant, false, field + ".jupiter_tisserand_invariant");
    ...
    checkString(d.ascending_node_longitude, false, field + ".ascending_node_longitude");
    ...
    d.orbit_class = OrbitClassProxy.Create(d.orbit_class, field + ".orbit_class");
...
export class OrbitClassProxy {
  ...
  public static Create(d: any, field: string = 'root'): OrbitClassProxy {
    ...
    checkString(d.orbit_class_description, false, field + ".orbit_class_description");
